...
urlpatterns = [
    ...
    path('auth/password/reset/request/', api_views.password_reset_request, name='api_password_reset_request'),
    path('auth/password/reset/confirm/', api_views.password_reset_confirm, name='api_password_reset_confirm'),
